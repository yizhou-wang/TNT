...
MAT_folder = '/mnt/disk2/AIC19/aic19-track1-mtmc/train_prep'
img_folder = '/mnt/disk2/AIC19/aic19-track1-mtmc/train_images'
temp_folder = '/mnt/disk2/AIC19/aic19-track1-mtmc/tmp'
triplet_model = '/mnt/disk2/AIC19/aic19-track1-mtmc/models/aicity19_new/facenet/models/20201004-180914'
save_dir = '/mnt/disk2/AIC19/aic19-track1-mtmc/models/aicity19_new/tnt/model.ckpt'
...
y_conv = seq_nn_3d_v2.seq_nn(batch_X_x, batch_X_y, batch_X_w, batch_X_h, batch_X_a, batch_mask_1, batch_mask_2, batch_Y,
                             max_length, feature_size, keep_prob)
